...
from livekit.plugins import deepgram, silero,openai,elevenlabs,cartesia
...
async def entrypoint(ctx: JobContext):
    ...
    #    tts=elevenlabs.TTS(model_id="cjVigY5qzO86Huf0OWal"),
    #     tts=cartesia.TTS(voice="248be419-c632-4f23-adf1-5324ed7dbf1d"),
         tts=cartesia.TTS(voice="b7d50908-b17c-442d-ad8d-810c63997ed9"),
    #    tts=elevenlabs.TTS(model_id="Eric")
    #    tts=elevenlabs.TTS(voice="cjVigY5qzO86Huf0OWal"),
